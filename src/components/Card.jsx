    ...
    return (
        <div className="bg-white border rounded-md shadow-2xl shadow-black/5 text-left">
            <div className="rounded-t-md relative min-h-48">
                <Image src={image.formats.thumbnail.url || 'no-image.svg'} alt={image.alternativeText} fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" placeholder="blur" blurDataURL={blurData} className="object-cover rounded-t-md" />
            </div>
